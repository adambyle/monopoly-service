...
- <https://monopoly-byczf6dbera4fuhd.mexicocentral-01.azurewebsites.net/>
...
- `/games` &mdash; returns a list of all games
- `/games/:id` &mdash; the single game with the given ID (can also DELETE)
